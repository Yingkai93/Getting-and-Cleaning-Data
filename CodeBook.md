This code book describes the data used in this course project and the processing required to create the tidy data set.

Overview:
30 volunteers performed 6 different activities with a smartphone. The smartphone captured various data about their movements.
